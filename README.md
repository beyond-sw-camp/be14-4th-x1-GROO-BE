...
<details>
  ...
  - 감정 일기의 등록, 조회, 수정, 삭제 등 일기 관리 백엔드 구현
  - 감정 분석 결과로 얻은 아이템을 보여주는 화면의 프론트 개발 및 백엔드 연동

- **잘한 점**
  - 팀원들과의 활발한 소통과 협업을 통해 개발 효율을 높일 수 있었습니다. <br>
    예상치 못한 문제 상황에서도 서로를 격려하고 배려하는 분위기 속에서 프로젝트를 잘 마무리할 수 있었습니다.

- **아쉬운 점**
  - 백엔드 개발 중간에 기능이 계속 추가되면서 계획했던 프론트엔드 작업을 충분히 할 시간이 부족했습니다. <br>
    개발 일정이 촉박해지면서 일부 구현은 빠르게 처리해야 했고 이는 완성도나 디테일에 아쉬움을 남겼습니다.

- **앞으로의 개선 방향**
  - 앞으로는 초기 요구사항 정의를 좀 더 명확히 하고 개발 중간에 변경사항이 생기더라도 그 영향을 최소화할 수 있도록 구조를 유연하게 잡는 것이 중요하겠다는 교훈을 얻었습니다. <br>
    이번 프로젝트를 통해 기능 설계, API 연동, 팀워크 등 다양한 측면에서 성장할 수 있었고 이 경험을 발판 삼아 더 나은 개발자가 되도록 노력하겠습니다.|
